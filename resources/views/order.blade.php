    ...
    <form method="POST" action="{{ route('place-order') }}" id="orderForm">
        ...
        <div class="justify-center w-full gap-4 mt-5 md:flex md:space-y-0 space-y-7 bg-gray-900 p-2" id="user-form">
            <div class="shadow-2xl p-2 w-full md:w-3/4 ">
                ...
                <div class="py-2">
                    <div class="flex gap-2 ">
                        <p class="text-gray-100 text-md">Preffered Date and Time</p><span><i>(optional)</i></span>
                    </div>
                    <div class="space-y-2">
                        <div class="relative w-1/3">
                            ...
                            <input datepicker datepicker-autohide type="text" id="date" name="expected_date" class="hover:cursor-pointer border z-10 border-gray-700 bg-gray-800 text-gray-400 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
                        </div>
                        <input type="time" name="expected_time" id="time" class="hover:cursor-pointer border z-10 w-1/3 border-gray-700 bg-gray-800 text-gray-400 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select time">
                    </div>
                </div>
                <div class="py-2">
                    <div class="flex gap-2">
        ...
        <button data-modal-target="small-modal" data-modal-toggle="small-modal" onclick="populateReviewModal();"class="mt-5 float-right block w-full md:w-auto text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
           Submit
        </button>

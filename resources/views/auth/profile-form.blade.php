...
@section('content')
    <form action="{{ route('profile.registration') }}" method="POST">
        ...
        <div class="items-center py-4 bg-gray-800 text-gray-400 px-4 " id="profilesetting" role="tabpanel"
            ...
            <div
                class="flex flex-col items-center w-full mb-2 space-x-0 space-y-2 sm:flex-row sm:space-x-4 sm:space-y-0 sm:mb-4">
                <div class="w-full">
                    <x-input-label for="firstname" text="First Name" class="text-gray-300" />
                    <x-input-text id="firstname" name="first_name" class="border-none hover:cursor-default"
                        value="{{ old('firstname') }}" />
            ...
            <div class="mb-2 sm:mb-4">
                ...
                <x-input-text id="email" name="email" class="border-none hover:cursor-default"
                    value="{{ Auth::user()->email }}" readonly />

            </div>
            <div class="mb-2 sm:mb-4">
                <x-input-label for="contactnumber" text="Contact Number" class="text-gray-300" />
                <x-input-text id="contactnumber" type="number" name="contact_number"
            ...
            <div class="flex justify-end">
                <x-button-primary text="Save"
                    class="text-white bg-blue-700  hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">Save</x-button-primary>
            </div>

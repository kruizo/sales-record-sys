        ...
        <div class="p-4 md:p5" id="form-body">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="py-2">
                    ...
                    <x-input-text id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                        name="email" value="{{ old('email') }}" autocomplete="email" />
                </div>

                <div class="py-2">
                    <x-input-label for="password" text="Password" />
                    <x-input-text id="password" type="password"
                ...
                <div class="py-2">
                    ...
                    <x-input-text id="password-confirm" type="password" class="form-control" name="password_confirmation"
                        autocomplete="new-password" />
                </div>
                <div class="py-2">
                    <div class="flex items-start mb-5">
                        ...
                        <label for="terms" class="ms-2 text-sm font-medium text-gray-300 dark:text-gray-300">I agree with
                            the <a href="#" class="text-blue-600 hover:underline dark:text-blue-500"
                                tabindex="-1">terms and conditions</a></label>
                    </div>
                </div>
                <div class="py-2">

                ...
                <div class="flex w-full justify-center">
                    <div class="grid grid-cols-3 w-1/2 items-center">
                            ...
                            <div class="flex justify-center items-center mt-3 gap-4 col-span-2">
                                <button type="button" class="bg-gray-800 p-4 rounded-lg" aria-label="Decrease quantity of Alkaline" onclick="decrementInput('{{ $id }}')"><i class="fa fa-minus" aria-hidden="true"></i></button>
                                ...
                                <button type="button" class="bg-gray-800 p-4 rounded-lg hover:scale-110 hover:transition-all " aria-label="Increase quantity of Alkaline" onclick="incrementInput('{{ $id }}')">

<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a data-section="dashboard" href="{{ route('admin.dashboard') }}"
                    class="sidebar-link hover:cursor-pointer flex items-center p-2 text-gray-600 rounded-lg hover:border-l-2 hover:border-blue-700 ">
                    <svg id="sidebar-icon"
                        class="w-5 h-5  transition duration-75 dark:text-gray-400 group- dark:group-hover:text-white"
            ...
            <!-- <li>
                <button type="button"
                    ...
                    <span id="sidebar-icon"
                        class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap ">Analytics</span>
                ...
                <ul id="dropdown-example" class="hidden hover:cursor-pointer py-2 space-y-2">
                    ...
                    <li>
                        <a href="#"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Sales</a>
                    </li>
            ...
            <li>
                <a data-section="delivery" href="{{ route('admin.delivery') }}"
                    class="sidebar-link hover:cursor-pointer flex items-center text-gray-600 p-2 rounded-lg hover:border-l-2 hover:border-blue-700  group">
            ...
            <li>
                <a data-section="customers" href="{{ route('admin.customers') }}"
                    class="sidebar-link hover:cursor-pointer flex items-center p-2 text-gray-600 rounded-lg hover:border-l-2 hover:border-blue-700  group">
                    <svg id="sidebar-icon"
                        class="flex-shrink-0 w-5 h-5 transition duration-75 dark:text-gray-400 group- dark:group-hover:text-white"
            ...
            <li>
                <a data-section="reports" href="{{ route('admin.reports') }}"
                    class="sidebar-link hover:cursor-pointer flex items-center p-2 text-gray-600 rounded-lg hover:border-l-2 hover:border-blue-700  group">
                    <svg id="sidebar-icon"
                        class="flex-shrink-0 w-5 h-5  transition duration-75 dark:text-gray-400 group- dark:group-hover:text-white"

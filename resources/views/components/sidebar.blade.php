<aside id="logo-sidebar" class="fixed  top-0 left-0 z-40 w-64 h-screen  transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a data-section="dashboard" class="sidebar-link hover:cursor-pointer flex items-center p-2 text-gray-600 rounded-lg hover:border-l-2 hover:border-blue-700 ">
            ...
            <li>
                <a data-section="orders" class="sidebar-link hover:cursor-pointer flex items-center p-2 text-gray-600 rounded-lg hover:border-l-2 hover:border-blue-700  group">
                    <i id="sidebar-icon" class="fas fa-shopping-cart" class=" "></i>
                    <span class="flex-1 ms-3 whitespace-nowrap ">Orders</span>
                </a>
            </li>
            <li>
                <a data-section="delivery" class="sidebar-link hover:cursor-pointer flex items-center text-gray-600 p-2 rounded-lg hover:border-l-2 hover:border-blue-700  group">
            ...
            <li>
                <a data-section="customers" class="sidebar-link hover:cursor-pointer flex items-center p-2 text-gray-600 rounded-lg hover:border-l-2 hover:border-blue-700  group">
            ...
            <li>
                <a data-section="reports" class="sidebar-link hover:cursor-pointer flex items-center p-2 text-gray-600 rounded-lg hover:border-l-2 hover:border-blue-700  group">

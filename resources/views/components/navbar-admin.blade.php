    ...
    <div class="px-3 py-5 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="{{route('admin.home')}}" class="flex ms-2 md:me-24">
            ...
            <div class="flex items-center">
                <div class="flex items-center ms-3">
                    <div>
                        <button type="button" class="flex text-sm bg-gray-800 rounded md:block" aria-expanded="false" data-dropdown-toggle="dropdown-user">

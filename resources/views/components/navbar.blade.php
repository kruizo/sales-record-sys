<nav id="navbar" {{ $attributes->merge(['class' => 'backdrop-blur-lg transition-all sm:fixed z-20 bg-transparent text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 py-6']) }}>
    <div class="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-4 sm:px-20">
        <div class="flex items-center ">
            <button data-collapse-toggle="navbar-sticky" type="button" class="md:hidden mr-2 inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg hover:text-blue-500 aria-controls="navbar-sticky" aria-expanded="false">
        ...
        <div class="absolute top-24 md:top-0 items-center justify-between bg-gray-900 sm:bg-transparent hidden w-1/2 rounded-lg md:relative md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul class="flex font-poppins flex-col p-4 md:p-0 font-medium bg-gray-900 sm:bg-transparent rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 ">
                <li>
                    <a href="{{ route('/') }}#home" class=" block py-2 px-3 hover:hover:text-blue-500 text-gray-300 rounded bg-gray-900 md:bg-transparent sm:hover:text-blue-600 md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500">Home</a>
                </li>
                <li>
                    <a href="{{ route('/') }}#services" class="block py-2 px-3 text-gray-300 hover:hover:text-blue-500 bg-gray-900 rounded md:bg-transparent sm:hover:text-blue-600 md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500">Services</a>
                </li>
                <li>
                    <a href="{{ route('/') }}#about" class="block py-2 px-3 text-gray-300 hover:hover:text-blue-500 bg-gray-900 rounded md:bg-transparent sm:hover:text-blue-600 md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500">About</a>
                </li>
                <li>
                    <a href="{{ route('/') }}#contact" class="block py-2 px-3 text-gray-300 hover:hover:text-blue-500 bg-gray-900 rounded md:bg-transparent sm:hover:text-blue-600 md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500">Contact</a>
                </li>
            </ul>
        </div>
    </div>

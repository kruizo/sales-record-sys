                ...
                <div class="hidden" id="signin" role="tabpanel" aria-labelledby="signin-tab">
                    <div class="p-5">
                        ...
                        <form class="space-y-4" method="POST" action="{{ route('login') }}">
                            ...
                            <x-button-primary text="{{ __('Login') }}" type="submit" class="w-full"></x-button-primary>

                            <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                                Dont have an account? <x-link-text text="Create an account" href="{{route('register')}}"></x-link-text>
                            </div> 
                        </form>
                    </div>
                </div>
                    ...
                    <div class="p-4 md:p-5">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="text-sm font-medium mt-2 text-gray-500 ">
                                Already have an account? <x-link-text text="Sign in" href="{{route('login')}}"></x-link-text>
                            </div> 
                        </form>
                    </div>
                </div>

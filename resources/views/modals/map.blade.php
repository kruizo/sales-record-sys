    ...
    <div class="relative p-4 w-full max-w-md max-h-full min-w-full flex justify-center">
        ...
        <div id="modal-content" class="relative bg-gray-800 rounded-lg shadow  w-3/4 ">
            ...
            <div class="p-4 md:p-5 space-y-4 w-full h-full">
                ...
                <p style="text-align:center;" id="locationtext"><span id="locationtxt">Pick a location on the map </span></p>
                <div class="flex items-center gap-2 justify-center p-4 md:p-5">
                    <x-button-primary type="button" class="w-1/3 bg-transparent border-2 text-black" onclick="resetmarker('map');" data-modal-hide="mapmodal" id="reset" text="Cancel">Cancel</x-button-primary>

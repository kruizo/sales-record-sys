    ...
    <div data-aos="zoom-out" data-aos-once="true">
        <div class="gap-8  items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6 flex lg:flex-row flex-col-reverse">
            <div class="mt-4 md:mt-0">
                ...
                <p class="mb-6 font-light text-gray-300 md:text-lg dark:text-gray-300">A dedicated delivery rider stands proudly next to a sleek motorcycle loaded with pristine, blue water cooler bottles. With the sun casting a warm glow, it portrays the convenience and speed of our water delivery service. Whether at your home or office, we ensure quick and efficient hydration delivery with a smile.</p>
            </div>
            <div class="relative w-full image-zoom-container overflow-hidden rounded-2xl">
                ...
                <img class="w-full h-72 object-cover dark:hidden image-zoom" src="{{asset('assets/image/service4.png')}}" alt="service-image-shop">
            </div>
        </div>
    </div>
    ...
    <div data-aos="zoom-out" data-aos-once="true">
        <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6 flex lg:flex-row-reverse flex-col">
            <div class="relative w-full image-zoom-container overflow-hidden rounded-2xl">
                ...
                <img class="w-full h-72 object-cover dark:hidden image-zoom" src="{{asset('assets/image/service3.png')}}" alt="service-image-1">
            </div>
            
            <div class="mt-4 md:mt-0">
                <h2 class="mb-4 text-3xl tracking-tight text-gray-200 font-poppins dark:text-white">Crafting Pure Hydration: The Art of Gallon Refilling</h2>
                <p class="mb-6 font-light text-gray-300 md:text-lg dark:text-gray-300">Precision meets purity as a skilled hand carefully refills a water gallon at our station. The crystal-clear water flows gracefully, filling the container to the brim. It's a snapshot of our commitment to delivering pristine hydration, one gallon at a time. Trust us for the freshest, most refreshing water for your home or office.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="wave relative overflow-hidden pb-40" id="about">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
        ...
        <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
            <div class="items-center bg-gray-900 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700" data-aos="flip-right" data-aos-once="true">
                    <img class="w-3/5 h-full object-cover rounded-lg sm:rounded-none sm:rounded-l-lg" src="{{asset('assets/image/service1.png')}}" alt="Bonnie Avatar">
            ...
            <div class="items-center bg-gray-900 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700" data-aos="flip-right" data-aos-once="true">
                    <img class="w-3/5 h-full object-cover rounded-lg sm:rounded-none sm:rounded-l-lg" src="{{asset('assets/image/service3.png')}}" alt="Bonnie Avatar">
                <div class="p-5 w-full text-center">
                    <h3 class="text-2xl font-bold tracking-tight text-gray-300 dark:text-white">
                        <a href="#">Refill</a>
                    </h3>
            ...
            <div class="items-center bg-gray-900 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700" data-aos="flip-right" data-aos-once="true">
                    <img class="w-3/5 h-full object-cover rounded-lg sm:rounded-none sm:rounded-l-lg" src="{{asset('assets/image/discount.jpeg')}}" alt="Bonnie Avatar">
                <div class="p-5 w-full text-center">
                    <h3 class="text-2xl font-bold tracking-tight text-gray-300 dark:text-white">
                        <a href="#">Discounts</a>
                    </h3>
                    <p class="mt-3 mb-4 font-light text-gray-400 dark:text-gray-400">Applicable to confirmed purchases.</p>
                </div>
            </div>
            <div class="items-center bg-gray-900 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700" data-aos="flip-right" data-aos-once="true">
                    <img class="w-3/5 h-full object-cover rounded-lg sm:rounded-none sm:rounded-l-lg" src="{{asset('assets/image/service4.png')}}" alt="Bonnie Avatar">
                <div class="p-5 w-full text-center">
                    <h3 class="text-2xl font-bold tracking-tight text-gray-300 dark:text-white">
                        <a href="#">Wholesale</a>
                    </h3>
                    <p class="mt-3 mb-4 font-light text-gray-400 dark:text-gray-400">Massive discounts for everybody.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 ">
        <div class="mx-auto max-w-screen-sm text-center">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold leading-tight text-gray-900 dark:text-white font-poppins">Enjoy your quality water today</h2>
...
<section class="py-8 bg-gray-50 lg:py-24 dark:bg-gray-900">
    <div class="px-4 mx-auto max-w-8xl lg:px-4">
        <div class="xl:mx-64 2xl:mx-80">
            <h1 class="mb-4 tracking-tight font-bold leading-tight text-gray-900 lg:font-extrabold text-4xl lg:leading-none dark:text-white text-center lg:mb-7 font-poppins">Contact us</h1>
            <p class="mb-10 text-lg font-normal text-gray-500 dark:text-gray-400 lg:text-center lg:text-xl">Reach us for inquiries. We respond in not less than an hour😁</p>
        </div>
    </div>
    <div class="px-4 mx-auto max-w-8xl lg:px-4">
            ...
            <form>
                <div class="grid md:gap-8 md:grid-cols-2">
                    ...
                    <div class="mb-6">
                        ...
                        <input required="" type="text" id="last_name" placeholder="Doe" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="">
                    </div>
                </div>
                <div class="mb-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input required="" type="text" id="subject" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Subject name" value="">
                    </div>
                        <div class="mb-6"><label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Message</label>
                            <textarea required="" id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your message..."></textarea>
                        </div>
                            <button class="text-white font-medium rounded-lg text-base px-5 py-3 w-full sm:w-auto text-center bg-blue-700" type="submit"><span class="flex justify-center items-center">Send message</span></button>
                        </form>
                    </div>
                </div>
            </section>
